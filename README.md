...
* **[Discord Bot Docker Restart: 3 Mistakes That Bit Us in Prod](https://dev.to/oleksandr_kuryzhev_42873f/discord-bot-docker-restart-3-mistakes-that-bit-us-in-prod-19bm)** — **2** 👍 · 1 💬
* **[When the Agent Is Wrong: Surface Real Kubernetes Errors, Not Model Guesses](https://dev.to/devamparikh/when-the-agent-is-wrong-surface-real-kubernetes-errors-not-model-guesses-5ank)** — **1** 👍 · 0 💬
